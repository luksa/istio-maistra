...
func (s *DependenciesStub) RunOrFail(cmd string, stdin io.Reader, args ...string) {
	s.execute(false /*quietly*/, cmd, args...)
}

func (s *DependenciesStub) Run(cmd string, stdin io.Reader, args ...string) error {
	s.execute(false /*quietly*/, cmd, args...)
	return nil
}

func (s *DependenciesStub) RunQuietlyAndIgnore(cmd string, stdin io.Reader, args ...string) {
